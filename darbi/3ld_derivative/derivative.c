...
void data_table_to_file(int i,float a,float b,float delta_x);
float func1(float x, float x1,float delta_x);
float func2(float x, float x1,float x2,float delta_x);
void main(){
 int k;
 ...
 data_table_to_file(k,a,b,delta_x);
}
float func1(float x,float x1, float delta_x){
float y;
 y= (x1-x)/delta_x;
...
void data_table_to_file(int k,float a,float b,float delta_x){
int i,j=k+1,c=k+2;
